...
*/
   cout<<"| "<<setw(11)<<"Identifier  | "<<setw(8)<<"  Type    | "<<setw(8)<<"  Shape  | "<<setw(5)<<" Rows | "<<setw(5)<<" Cols |"<<endl;
   cout<<"------------------------------------------------------"<<endl;
   for(unsigned int i = 0; i < table.size(); ++i) {
   cout<<"| "<<setw(11)<<table[i]->getIdentifier()<<" | "<<setw(9)<<table[i]->getType()
       <<" | "<<setw(8)<<table[i]->getShape()<<" | "<<setw(5)<<table[i]->getSize()<<" | "<<setw(5)<<table[i]->getSize2()<<" | "<<endl;
   }
 
}

void SymbolTable::printLocalTable() {
   cout<<"| "<<setw(11)<<"Identifier  | "<<setw(8)<<"  Type    | "<<setw(8)<<"  Shape  | "<<setw(5)<<" Rows | "<<setw(5)<<" Cols | "<<setw(9)<<"Call Type |"<<endl;
   cout<<"------------------------------------------------------------------"<<endl;
   for(unsigned int i = 0; i < table.size(); ++i) {
   cout<<"| "<<setw(11)<<table[i]->getIdentifier()<<" | "<<setw(9)<<table[i]->getType()
       <<" | "<<setw(8)<<table[i]->getShape()<<" | "<<setw(5)<<table[i]->getSize()<<" | "<<setw(5)<<table[i]->getSize2()<<" | "<<setw(9)<<table[i]->getCallType()<<" |"<<endl;
   }
}
