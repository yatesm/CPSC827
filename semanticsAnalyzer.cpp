...
SemanticsAnalyzer::SemanticsAnalyzer(std::stack <string> &s) : intermediateInteger(0), intermediateReal(0),
                                                               intermediateBool(0), intermediateLabel(0),
                                                               cData(CompilerData::getInstance()),
                                                               labelStack(new stack <string>), semanticStack(&s),
...
void SemanticsAnalyzer::goSemanticsGo(int productionNumber) {
    ...
    switch (productionNumber) {
        ...
        case 10:
            ...
            obj = new SemanticObject(varString, tempObject->getShape(), tempObject->getSize(), tempObject->getSize2(),
                                     tempObject->getType());
            if (localFlag)
